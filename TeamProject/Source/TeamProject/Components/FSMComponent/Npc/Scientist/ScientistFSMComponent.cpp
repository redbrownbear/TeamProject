...
UScientistFSMComponent::UScientistFSMComponent()
{
	eCurrentState = ENpcState::Walk;
}

void UScientistFSMComponent::UpdateIdle(float DeltaTime)
{
	Super::UpdateIdle(DeltaTime);
}

void UScientistFSMComponent::UpdateTalk(float DeltaTime)
{
...
void UScientistFSMComponent::UpdateWalk(float DeltaTime)
{
