...
#include "Animation/AnimNotify/Monster/AnimNotify_LynelCry.h"
#include "Misc/Utils.h"
#include "Actors/Effect/ParticleEffect_AlphaUpScaleUp.h"

void UAnimNotify_LynelCry::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	...
	ParticleEffect->SetData(ParticleEffectName::Lynel_Cry);
